CREATE DATABASE  IF NOT EXISTS `darshil` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `darshil`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: darshil
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'darshil'
--
